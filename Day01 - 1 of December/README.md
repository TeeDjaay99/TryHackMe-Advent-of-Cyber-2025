...
![Listing hidden files](screenshots/ls-la-hidden-files.png)
...
*Finding attacker commands left in `.bash_history`.*  

![Task completed](screenshots/Day01-completed.png)
*Proof of completing Day 1.* 
